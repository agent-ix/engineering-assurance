...
`make test` on this tree reports 186 passed / 2 skipped from a linked worktree
and 188 passed / 0 skipped from the primary clone. The two tests locate the
campaign repositories at `REPO_ROOT.parent`, and a linked worktree has no such
siblings.
