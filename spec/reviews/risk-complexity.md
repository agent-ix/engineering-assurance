...
| --- | --- | --- | --- |
| FND-001 | high | Mitigated: no-write paths, immutable provenance, pinned full-runtime executable identity, current-revision evidence binding, state exclusivity, and explicit terminal-event tests protect the primary epistemic boundary. | TC-002; TC-007; TC-024; TC-046..TC-051 |
