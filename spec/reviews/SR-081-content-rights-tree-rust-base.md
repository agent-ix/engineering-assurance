...
direct `make test` cutover, and deletion of the replaced Python checker after
same-revision correspondence and rollback evidence. It does not change content
...
cutover may proceed. TC-111 through TC-115 remain incomplete for their wider
archive, installed-bundle, host-configuration, and final-removal populations.
