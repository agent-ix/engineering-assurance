...
| FND-004 | high | Resolved: cross-boundary run-id reuse, executable substitution, and inferred terminal outcomes fail closed, while explicit acceptance and rejection are both retained. | FR-005-AC-6..AC-7; FR-006-AC-5..AC-6; TC-047..TC-050 | missing-requirement |
