...
| NFR-005-AC-2 | Every Rust test that verifies a specification criterion imports `ix_trace_rs::trace` and uses bare `#[trace("TC-...", "...-AC-...")]`; path-qualified trace macros are rejected. | Static (TC-117) |
...
locally. Inspect first-party executable and host-dispatch paths against ADR-002.
