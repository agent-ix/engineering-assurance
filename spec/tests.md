...
| TC-083 | Every recorded artifact digest matches this tree over at least the ten schema assets | Integration | P0 | FR-012-AC-5 | ✅ Native Rust observer, guarded against passing on an empty artifact population |
