...
| TC-175 | A complete synthetic executor-observed host context is stable and identity-bound, exposes no raw machine identifier, and an incomplete or malformed context is absent; Linux execution samples this context before launch | Unit | P0 | FR-019-AC-8 | ✅ parser and canonical-result identity cases passing; Linux live sampling pending |
