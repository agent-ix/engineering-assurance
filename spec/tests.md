...
| FR-017 | FR-017-AC-3 | TC-111 | 🚧 Membership, pure content-rights, manifest, and npm stage/cleanup/publication-refusal slices backed; content-rights tree, archive, and installed-bundle integration pending |
| FR-017 | FR-017-AC-4 | TC-112 | 🚧 npm lifecycle hooks are declarative Rust dispatch; content-rights and remaining host-configuration census pending |
