...
pub const TYPES: &[TypeMeta] = &[
    ...
    crate::identity::TypeMeta {
        identity: "ix://agent-ix/engineering-assurance-campaign/EN-006",
        display_name: "ProcedureInputOriginKind",
        kind: "campaign_enum",
        rust_name: "ProcedureInputOriginKind",
        roles: &["engineering-assurance:campaign_enum"],
        unknown_policy: "reject",
        origin: crate::identity::OriginMeta {
            source: Some(crate::identity::SourceLocusMeta {
                source_identity: "ix://agent-ix/engineering-assurance-campaign/spec",
                path: "spec/functional/EN-006-procedure-input-origin-kind.md",
                start_line: 1,
                start_column: 1,
                end_line: None,
                end_column: None,
    ...
    crate::identity::TypeMeta {
        identity: "ix://agent-ix/engineering-assurance-campaign/VO-012",
        display_name: "ProcedureInputOrigin",
        kind: "record",
        rust_name: "ProcedureInputOrigin",
        roles: &["engineering-assurance:campaign_value"],
        unknown_policy: "reject",
        origin: crate::identity::OriginMeta {
            source: Some(crate::identity::SourceLocusMeta {
        ...
        fields: crate::types::procedure_input_origin::FIELDS,
        relationships: &[],
        operations: &[],
        clauses: &[],
        extensions: &[],
